...
func (t *Translator) loadStrings() {
	...
	t.strings[IT] = map[string]string{
		...
		"dialog.clone_server":          "Clona Server",
		"dialog.clone_to":              "Seleziona dove clonare il server:",
		"dialog.clone_success":         "Server '%s' clonato con successo",
		"dialog.add_method":            "Come vuoi aggiungere il server?",
		"dialog.add_via_form":          "Compila Form",
		"dialog.add_via_json":          "Incolla JSON",
		"dialog.add_json_title":        "Aggiungi Server da JSON",
		"dialog.add_json_hint":         "Incolla la configurazione JSON del server MCP",
		"dialog.json_invalid":          "JSON non valido",
		"dialog.json_missing_fields":   "Il JSON deve contenere almeno 'name' e 'type'",
	...
	t.strings[EN] = map[string]string{
		...
		"dialog.clone_server":          "Clone Server",
		"dialog.clone_to":              "Select where to clone the server:",
		"dialog.clone_success":         "Server '%s' cloned successfully",
		"dialog.add_method":            "How do you want to add the server?",
		"dialog.add_via_form":          "Fill Form",
		"dialog.add_via_json":          "Paste JSON",
		"dialog.add_json_title":        "Add Server from JSON",
		"dialog.add_json_hint":         "Paste the MCP server JSON configuration",
		"dialog.json_invalid":          "Invalid JSON",
		"dialog.json_missing_fields":   "JSON must contain at least 'name' and 'type'",
		"form.name":           "Name",
	...
	t.strings[FR] = map[string]string{
		...
		"dialog.clone_server":          "Cloner Serveur",
		"dialog.clone_to":              "Sélectionnez où cloner le serveur:",
		"dialog.clone_success":         "Serveur '%s' cloné avec succès",
		"dialog.add_method":            "Comment voulez-vous ajouter le serveur?",
		"dialog.add_via_form":          "Remplir le formulaire",
		"dialog.add_via_json":          "Coller JSON",
		"dialog.add_json_title":        "Ajouter serveur depuis JSON",
		"dialog.add_json_hint":         "Collez la configuration JSON du serveur MCP",
		"dialog.json_invalid":          "JSON invalide",
		"dialog.json_missing_fields":   "Le JSON doit contenir au moins 'name' et 'type'",
		"form.name":           "Nom",
	...
	t.strings[DE] = map[string]string{
		...
		"dialog.clone_server":          "Server klonen",
		"dialog.clone_to":              "Wählen Sie wohin der Server geklont werden soll:",
		"dialog.clone_success":         "Server '%s' erfolgreich geklont",
		"dialog.add_method":            "Wie möchten Sie den Server hinzufügen?",
		"dialog.add_via_form":          "Formular ausfüllen",
		"dialog.add_via_json":          "JSON einfügen",
		"dialog.add_json_title":        "Server aus JSON hinzufügen",
		"dialog.add_json_hint":         "Fügen Sie die JSON-Konfiguration des MCP-Servers ein",
		"dialog.json_invalid":          "Ungültiges JSON",
		"dialog.json_missing_fields":   "JSON muss mindestens 'name' und 'type' enthalten",
		"form.name":           "Name",
	...
	t.strings[ES] = map[string]string{
		...
		"dialog.clone_server":          "Clonar Servidor",
		"dialog.clone_to":              "Selecciona dónde clonar el servidor:",
		"dialog.clone_success":         "Servidor '%s' clonado con éxito",
		"dialog.add_method":            "¿Cómo quieres agregar el servidor?",
		"dialog.add_via_form":          "Rellenar formulario",
		"dialog.add_via_json":          "Pegar JSON",
		"dialog.add_json_title":        "Agregar servidor desde JSON",
		"dialog.add_json_hint":         "Pega la configuración JSON del servidor MCP",
		"dialog.json_invalid":          "JSON inválido",
		"dialog.json_missing_fields":   "El JSON debe contener al menos 'name' y 'type'",
		"form.name":           "Nombre",
	...
	t.strings[PT] = map[string]string{
		...
		"dialog.clone_server":          "Clonar Servidor",
		"dialog.clone_to":              "Selecione onde clonar o servidor:",
		"dialog.clone_success":         "Servidor '%s' clonado com sucesso",
		"dialog.add_method":            "Como você quer adicionar o servidor?",
		"dialog.add_via_form":          "Preencher formulário",
		"dialog.add_via_json":          "Colar JSON",
		"dialog.add_json_title":        "Adicionar servidor a partir de JSON",
		"dialog.add_json_hint":         "Cole a configuração JSON do servidor MCP",
		"dialog.json_invalid":          "JSON inválido",
		"dialog.json_missing_fields":   "O JSON deve conter pelo menos 'name' e 'type'",
		"form.name":           "Nome",
	...
	t.strings[JA] = map[string]string{
		...
		"dialog.clone_server":          "サーバー複製",
		"dialog.clone_to":              "複製先を選択:",
		"dialog.clone_success":         "サーバー '%s' が正常に複製されました",
		"dialog.add_method":            "サーバーの追加方法を選択してください",
		"dialog.add_via_form":          "フォーム入力",
		"dialog.add_via_json":          "JSON貼り付け",
		"dialog.add_json_title":        "JSONからサーバーを追加",
		"dialog.add_json_hint":         "MCPサーバーのJSON設定を貼り付けてください",
		"dialog.json_invalid":          "無効なJSON",
		"dialog.json_missing_fields":   "JSONには少なくとも 'name' と 'type' が必要です",
		"form.name":           "名前",
	...
	t.strings[KO] = map[string]string{
		...
		"dialog.clone_server":          "서버 복제",
		"dialog.clone_to":              "복제할 위치 선택:",
		"dialog.clone_success":         "서버 '%s'이(가) 성공적으로 복제되었습니다",
		"dialog.add_method":            "서버를 어떻게 추가하시겠습니까?",
		"dialog.add_via_form":          "양식 작성",
		"dialog.add_via_json":          "JSON 붙여넣기",
		"dialog.add_json_title":        "JSON에서 서버 추가",
		"dialog.add_json_hint":         "MCP 서버 JSON 구성을 붙여넣으세요",
		"dialog.json_invalid":          "잘못된 JSON",
		"dialog.json_missing_fields":   "JSON에는 최소한 'name'과 'type'이 포함되어야 합니다",
		"form.name":           "이름",
	...
	t.strings[CN] = map[string]string{
		...
		"dialog.clone_server":          "克隆服务器",
		"dialog.clone_to":              "选择克隆位置：",
		"dialog.clone_success":         "服务器 '%s' 克隆成功",
		"dialog.add_method":            "您想如何添加服务器？",
		"dialog.add_via_form":          "填写表单",
		"dialog.add_via_json":          "粘贴JSON",
		"dialog.add_json_title":        "从JSON添加服务器",
		"dialog.add_json_hint":         "粘贴MCP服务器的JSON配置",
		"dialog.json_invalid":          "无效的JSON",
		"dialog.json_missing_fields":   "JSON必须至少包含 'name' 和 'type'",
		"form.name":           "名称",
	...
	t.strings[UK] = map[string]string{
		...
		"dialog.clone_server":          "Клонувати сервер",
		"dialog.clone_to":              "Виберіть куди клонувати сервер:",
		"dialog.clone_success":         "Сервер '%s' успішно клоновано",
		"dialog.add_method":            "Як ви хочете додати сервер?",
		"dialog.add_via_form":          "Заповнити форму",
		"dialog.add_via_json":          "Вставити JSON",
		"dialog.add_json_title":        "Додати сервер з JSON",
		"dialog.add_json_hint":         "Вставте JSON конфігурацію MCP сервера",
		"dialog.json_invalid":          "Невалідний JSON",
		"dialog.json_missing_fields":   "JSON повинен містити принаймні 'name' та 'type'",
		"form.name":           "Назва",
